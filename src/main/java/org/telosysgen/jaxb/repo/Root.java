...
package org.telosysgen.jaxb.repo;
...
public class Root {
    ...
    protected Root.TableList tableList;
     ...
     *     
     */
    public Root.TableList getTableList() {
        return tableList;
    }
     ...
     *     
     */
    public void setTableList(Root.TableList value) {
    ...
    public static class TableList {
        ...
        protected List<Root.TableList.Table> table;
         ...
         * {@link Root.TableList.Table }
         * 
         * 
         */
        public List<Root.TableList.Table> getTable() {
            if (table == null) {
                table = new ArrayList<Root.TableList.Table>();
            }
            return this.table;
        }
        ...
        public static class Table {
            ...
            protected List<Root.TableList.Table.Column> column;
            protected List<Root.TableList.Table.Link> link;
            protected List<Root.TableList.Table.Fk> fk;
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link Root.TableList.Table.Column }
             * 
             * 
             */
            public List<Root.TableList.Table.Column> getColumn() {
                if (column == null) {
                    column = new ArrayList<Root.TableList.Table.Column>();
                }
                return this.column;
            }
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link Root.TableList.Table.Link }
             * 
             * 
             */
            public List<Root.TableList.Table.Link> getLink() {
                if (link == null) {
                    link = new ArrayList<Root.TableList.Table.Link>();
                }
                return this.link;
            }
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link Root.TableList.Table.Fk }
             * 
             * 
             */
            public List<Root.TableList.Table.Fk> getFk() {
                if (fk == null) {
                    fk = new ArrayList<Root.TableList.Table.Fk>();
                }
                return this.fk;
            }
            ...
            public static class Fk {
                ...
                protected List<Root.TableList.Table.Fk.Fkcol> fkcol;
                @XmlAttribute(name = "name")
                protected String name;
                 ...
                 * <p>
                 * Objects of the following type(s) are allowed in the list
                 * {@link Root.TableList.Table.Fk.Fkcol }
                 * 
                 * 
                 */
                public List<Root.TableList.Table.Fk.Fkcol> getFkcol() {
                    if (fkcol == null) {
                        fkcol = new ArrayList<Root.TableList.Table.Fk.Fkcol>();
                    }
                    return this.fkcol;
                }
            ...
            public static class Link {
                ...
                @XmlElement(required = true)
                protected Root.TableList.Table.Link.JoinColumns joinColumns;
                 ...
                 * @return
                 *     possible object is
                 *     {@link Root.TableList.Table.Link.JoinColumns }
                 *     
                 */
                public Root.TableList.Table.Link.JoinColumns getJoinColumns() {
                    return joinColumns;
                }
                 ...
                 *     
                 */
                public void setJoinColumns(Root.TableList.Table.Link.JoinColumns value) {
                ...
                public static class JoinColumns {
                    ...
                    protected List<Root.TableList.Table.Link.JoinColumns.JoinColumn> joinColumn;
                     ...
                     * <p>
                     * Objects of the following type(s) are allowed in the list
                     * {@link Root.TableList.Table.Link.JoinColumns.JoinColumn }
                     * 
                     * 
                     */
                    public List<Root.TableList.Table.Link.JoinColumns.JoinColumn> getJoinColumn() {
                        if (joinColumn == null) {
                            joinColumn = new ArrayList<Root.TableList.Table.Link.JoinColumns.JoinColumn>();
                        }
